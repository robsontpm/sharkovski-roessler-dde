...
set output 'rossler-3period-C1-tail-coords.pdf'
set xlabel 'max Ai'
...
plot \
    'bin/plots/BOX_c3_2.dat' u 5:7:6:8 w boxxy fs solid 0.50 fc rgb 'light-blue' notitle,\
    'bin/plots/Pc3_1.dat.csv' u 5:7:6:8 w boxxy fs solid 0.50 fc rgb 'green' notitle,\
